          ...
          m('.col-12.col-sm-auto.text-center', [
            ...
            m('.sub-header', [
              m('.d-inline.d-sm-block.pr-1.p-sm-0', [
                m.trust('I\'m a software engineer currently based out of the Netherlands.')
              ]),
              m('.d-inline.d-sm-block', [
                m.trust('I establish an e-commerce nexus for fashion brands, labels and agencies.<br> I also create commercial and open source tools for developers.')
              ])
            ]),
            m('.row.justify-content-center.align-items-center.pt-5', [
              ...
              m('.col-auto', [
                m('a[href="https://twitter.com/sisselsiv"]', [
                  m('svg.icon', [
